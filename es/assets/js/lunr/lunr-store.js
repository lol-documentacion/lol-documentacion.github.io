var store = [{
        "title": "Argumentos de la línea de comandos de LolMiner [2022]",
        "excerpt":"You can use this list as a reference for all Launch Parameters supported by LolMiner.          You can download LolMiner 1.52a from here:   Download Now   Download (mirror)   Linux:  Under Linux you need to replace LolMiner.exe with ./LolMiner in the command-line examples below.   ","categories": ["documentation"],
        "tags": ["LolMiner"],
        "url": "https://lolminer.site/documentation/setup/",
        "teaser": "https://lolminer.site/assets/images/thumbs/500x300.png"
      },{
        "title": "Download lolMiner  1.29 - AMD GPU Miner [2022]",
