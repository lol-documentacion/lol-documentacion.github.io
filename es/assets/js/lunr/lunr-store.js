var store = [{
        ...
        "excerpt":"You can use this list as a reference for all Launch Parameters supported by LolMiner.          You can download LolMiner 1.56 from here:   Download Now   Download (mirror)   Linux:  Under Linux you need to replace LolMiner.exe with ./LolMiner in the command-line examples below.   ","categories": ["documentation"],
        "tags": ["LolMiner"],
